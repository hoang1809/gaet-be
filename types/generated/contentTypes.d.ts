...
export interface ApiAboutAbout extends Schema.SingleType {
  ...
  attributes: {
    ...
    phone_number1: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    phone_number2: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiBusinessBusiness extends Schema.CollectionType {
  ...
  attributes: {
    activities: Attribute.Component<'business.activity', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    activities_layout: Attribute.Enumeration<
...
export interface ApiGalleryGallery extends Schema.CollectionType {
  ...
  attributes: {
    ...
    localizations: Attribute.Relation<
      ...
      'api::gallery.gallery'
    >;
    media: Attribute.Media<'images' | 'videos' | 'files', true> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    type: Attribute.Enumeration<['image', 'video', 'file']> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiHistoryPageHistoryPage extends Schema.SingleType {
  ...
  attributes: {
    achievements: Attribute.Component<'about.achievement', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    > &
      Attribute.Private;
    history_of_development: Attribute.Text &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Attribute.Relation<
      ...
      'api::history-page.history-page'
    >;
    milestones: Attribute.Component<'about.history', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    banners: Attribute.Component<'about.banner', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    business_description: Attribute.Text &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    features: Attribute.Component<'about.feature', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Attribute.Relation<
      ...
      'api::home-page.home-page'
    >;
    partner_description: Attribute.Text &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiLeadershipPageLeadershipPage extends Schema.SingleType {
  ...
  attributes: {
    ...
    leaders: Attribute.Component<'about.leader', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiOrganizationPageOrganizationPage extends Schema.SingleType {
  ...
  attributes: {
    ...
    directly_affiliated_agencies: Attribute.Component<'about.name-card', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Attribute.Relation<
      ...
      'api::organization-page.organization-page'
    >;
    representative_offices: Attribute.Component<'about.name-card', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    subsidiary_companies: Attribute.Component<'about.name-card', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiVisionPageVisionPage extends Schema.SingleType {
  ...
  attributes: {
    core_values: Attribute.Component<'about.value', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    objectives: Attribute.Component<'about.name-card', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
